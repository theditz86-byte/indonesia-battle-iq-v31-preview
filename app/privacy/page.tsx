...
export const metadata:Metadata={title:"Kebijakan Privasi",description:"Kebijakan privasi Indonesia Battle IQ."}

export default function PrivacyPage(){
  return <LegalLayout eyebrow="Privasi" title="Kebijakan Privasi">
    <section><h2 className="text-xl font-black text-white">Data yang kami proses</h2><p className="mt-2">Indonesia Battle IQ memproses data yang Anda berikan atau yang diperlukan untuk menjalankan layanan, seperti username, Nama Arena, wilayah, foto profil bila diunggah, token sesi peserta, jawaban dan hasil tes, riwayat percobaan, serta bukti pembayaran bila Anda membeli fitur digital.</p></section>
    ...
    <section><h2 className="text-xl font-black text-white">Leaderboard publik</h2><p className="mt-2">Nama Arena, avatar bila tersedia, wilayah, skor Battle IQ, estimasi IQ Battle, ketepatan, waktu, dan peringkat dapat ditampilkan secara publik pada leaderboard. Kami tidak menampilkan password atau bukti pembayaran secara publik.</p></section>
    ...
    <section><h2 className="text-xl font-black text-white">Catatan hasil tes</h2><p className="mt-2">Estimasi IQ Battle adalah indikator performa pada sistem Indonesia Battle IQ dan bukan diagnosis psikologis, hasil psikotes klinis, atau pengganti asesmen oleh psikolog berwenang.</p></section>
