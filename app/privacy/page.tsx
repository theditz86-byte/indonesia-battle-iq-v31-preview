...
export const metadata:Metadata={title:"Kebijakan Privasi",description:"Kebijakan privasi ALZAVA Battle IQ."}
...
export default function PrivacyPage(){
  return <LegalLayout eyebrow="Privasi" title="Kebijakan Privasi">
    ...
    <section><h2 className="text-xl font-black text-white">Catatan hasil tes</h2><p className="mt-2">Estimasi IQ Battle adalah indikator performa pada sistem ALZAVA Battle IQ dan bukan diagnosis psikologis, hasil psikotes klinis, atau pengganti asesmen oleh psikolog berwenang.</p></section>
