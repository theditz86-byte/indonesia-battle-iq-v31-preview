...
export default function HelpPage(){
  return <LegalLayout eyebrow="Pusat Bantuan" title="Bantuan ALZAVA Battle Point">
    ...
    <section><h2 className="text-xl font-black text-white">Apakah percobaan Rp5.000 mempengaruhi ranking?</h2><p className="mt-2">Ya. Setelah 1 Ranked Attempt gratis habis, setiap kredit Rp5.000 membuka 1 Ranked Attempt tambahan. Jika Battle Point-nya lebih baik, hasil tersebut dapat memperbaiki posisi leaderboard resmi.</p></section>
    ...
    <section><h2 className="text-xl font-black text-white">Apa itu Laporan Premium?</h2><p className="mt-2">Laporan Premium seharga Rp5.000 membuka analisis domain kemampuan, kekuatan relatif, area pengembangan, rekomendasi latihan, dan PDF untuk satu hasil tes terbaru. Nilai IQ tetap ditampilkan secara privat di halaman hasil tes, bukan di leaderboard publik.</p></section>
    <section><h2 className="text-xl font-black text-white">Poin saya tidak masuk leaderboard</h2><p className="mt-2">Pastikan tes berhasil dikirim dan lolos pemeriksaan integritas. Ranked Attempt gratis maupun berbayar dapat mempengaruhi leaderboard; sistem memakai hasil terbaik sesuai aturan tie-break.</p></section>
