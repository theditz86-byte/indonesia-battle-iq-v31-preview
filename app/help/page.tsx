...
export default function HelpPage(){
  return <LegalLayout eyebrow="Pusat Bantuan" title="Bantuan ALZAVA Battle IQ">
    ...
    <section><h2 className="text-xl font-black text-white">Apa itu Laporan Premium?</h2><p className="mt-2">Laporan Premium seharga Rp5.000 membuka analisis domain kemampuan, kekuatan relatif, area pengembangan, rekomendasi latihan, dan tampilan laporan yang dapat disimpan sebagai PDF.</p></section>
