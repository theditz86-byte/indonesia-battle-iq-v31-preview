...
export default function HelpPage(){
  return <LegalLayout eyebrow="Pusat Bantuan" title="Bantuan Indonesia Battle IQ">
    <section><h2 className="text-xl font-black text-white">Bagaimana cara mulai?</h2><p className="mt-2">Buat akun peserta, lengkapi Nama Arena dan wilayah, lalu buka menu Tes Nalar. Format saat ini adalah 30 soal dalam 15 menit dan setiap season menyediakan 2 Ranked Attempt gratis.</p></section>
