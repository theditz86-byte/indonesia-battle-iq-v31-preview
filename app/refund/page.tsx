...
export default function RefundPage(){
  return <LegalLayout eyebrow="Pembayaran" title="Kebijakan Pengembalian Dana">
    ...
    <section><h2 className="text-xl font-black text-white">Setelah fitur digital aktif</h2><p className="mt-2">Kredit Ranked Attempt atau Laporan Premium yang sudah berhasil diaktifkan pada akun umumnya tidak dapat dikembalikan karena manfaat digital sudah diberikan.</p></section>
