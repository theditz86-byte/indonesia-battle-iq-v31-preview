...
export default function TermsPage(){
  return <LegalLayout eyebrow="Ketentuan" title="Syarat & Ketentuan">
    ...
    <section><h2 className="text-xl font-black text-white">Fair play</h2><p className="mt-2">Peserta dilarang menggunakan bantuan orang lain, bot, kalkulator, pencarian web, atau cara lain yang bertujuan memanipulasi kompetisi. Pengelola dapat meninjau atau membatalkan hasil yang memiliki indikasi penyalahgunaan berdasarkan bukti teknis yang tersedia.</p></section>
