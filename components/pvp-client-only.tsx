...
import { PvpDeathGameBridge } from "@/components/pvp-death-game-bridge"
import { PvpInviteBridge } from "@/components/pvp-invite-bridge"
...
export function PvpClientOnly(){
  ...
  return <><PvpResultBridge/><PvpDeathGameBridge/><PvpInviteBridge/><PvpArena/></>
}
