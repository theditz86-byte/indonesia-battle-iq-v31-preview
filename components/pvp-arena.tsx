    ...
    <div className="w-full max-w-xl overflow-hidden rounded-3xl border border-cyan-300/20 bg-[#07152d] shadow-[0_30px_100px_rgba(0,0,0,.6)]">
      ...
      <div className="space-y-4 p-6">
        <div className="grid gap-3 sm:grid-cols-2">
          <div className="rounded-2xl border border-white/10 bg-white/[.04] p-4"><Timer className="h-5 w-5 text-cyan-300"/><p className="mt-2 text-sm font-black text-white">10 menit penuh</p><p className="mt-1 text-xs leading-5 text-slate-400">Begitu pertandingan dimulai, timer terus berjalan sampai habis.</p></div>
