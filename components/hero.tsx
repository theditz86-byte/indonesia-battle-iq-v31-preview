      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-36 pt-12 sm:px-6">
        <div className="grid items-center gap-5 lg:grid-cols-[minmax(0,330px)_minmax(0,1fr)_minmax(0,300px)]">
          <div className="flex flex-col items-start text-left">
            <span className="inline-flex items-center rounded-full border border-cyan-400/30 bg-cyan-400/10 px-4 py-1.5 text-[11px] font-bold uppercase tracking-widest text-cyan-300">Kompetisi Battle Point Nasional</span>
            <h1 className="mt-6 text-5xl font-black leading-[0.95] tracking-tight text-white sm:text-6xl">
              ...
              <span className="bg-gradient-to-r from-cyan-400 via-sky-400 to-indigo-400 bg-clip-text text-transparent">Taklukkan Peringkat.</span>
            </h1>
            <p className="mt-6 max-w-sm text-sm leading-relaxed text-slate-300">Tantang kemampuan berpikir logis, analitis, dan strategis. Kumpulkan poin terbaikmu dan bersaing dengan peserta dari seluruh Indonesia.</p>
            <div className="mt-7 flex flex-wrap gap-4">
              <a href="/battle-test" className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 px-6 py-3.5 text-sm font-bold text-white shadow-[0_0_28px_rgba(99,102,241,0.55)] transition-transform hover:scale-[1.03]">Mulai Tes Kemampuan <ArrowRight className="h-4 w-4" /></a>
          ...
          <div className="flex flex-col items-end gap-6">
            <p className="max-w-xs text-right text-sm italic leading-relaxed text-cyan-100/80">&ldquo;Setiap poin adalah langkah menuju posisi terbaikmu.&rdquo;</p>
