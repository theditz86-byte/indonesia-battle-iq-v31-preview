...
const spots: Record<number, PodiumSpot> = {
  1: {
    ...
    crownOffset: "-top-11",
    crown: "/images/crown-gold-opt.webp?v=cf3",
    laurel: "/images/laurel-gold-opt.webp?v=cf3",
  ...
  2: {
    ...
    crownSize: "h-14 w-14",
    crownOffset: "-top-8",
    crown: "/images/crown-silver-opt.webp?v=cf3",
    laurel: "/images/laurel-silver-opt.webp?v=cf3",
  ...
  3: {
    ...
    crownSize: "h-14 w-14",
    crownOffset: "-top-8",
    crown: "/images/crown-bronze-opt.webp?v=cf3",
    laurel: "/images/laurel-bronze-opt.webp?v=cf3",
