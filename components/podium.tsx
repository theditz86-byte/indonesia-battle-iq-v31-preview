...
const spots: Record<number, PodiumSpot> = {
  1: {
    ...
    crownSize: "h-14 w-14",
    crownOffset: "-top-9",
    crown: "/images/crown-gold.webp?v=cf2",
    laurel: "/images/laurel-gold.svg?v=cf2",
  ...
  2: {
    ...
    crownSize: "h-11 w-11",
    crownOffset: "-top-6",
    crown: "/images/crown-silver.webp?v=cf2",
    laurel: "/images/laurel-silver.svg?v=cf2",
  ...
  3: {
    ...
    crownSize: "h-11 w-11",
    crownOffset: "-top-6",
    crown: "/images/crown-bronze.webp?v=cf2",
    laurel: "/images/laurel-bronze.svg?v=cf2",
