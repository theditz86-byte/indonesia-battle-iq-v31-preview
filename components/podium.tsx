...
const spots: Record<number, PodiumSpot> = {
  1: {
    ...
    crownOffset: "-top-11",
    crown: "/images/crown-gold-cf.webp?v=cf4",
    laurel: "/images/laurel-gold-cf.webp?v=cf4",
  ...
  2: {
    ...
    crownSize: "h-14 w-14",
    crownOffset: "-top-8",
    crown: "/images/crown-silver-cf.webp?v=cf4",
    laurel: "/images/laurel-silver-cf.webp?v=cf4",
  ...
  3: {
    ...
    crownSize: "h-14 w-14",
    crownOffset: "-top-8",
    crown: "/images/crown-bronze-cf.webp?v=cf4",
    laurel: "/images/laurel-bronze-cf.webp?v=cf4",
